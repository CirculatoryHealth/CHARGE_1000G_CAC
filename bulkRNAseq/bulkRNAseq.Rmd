...
# update list
CAC_gene_list <- read.xlsx(paste0(TARGET_loc, "/20210127_Overview_Genes_MMBos_Sander.xlsx"))
...
- _DUPD1_ => _DUSP29_, ==> not found
- _RP11-145E5.5_ ==> not found
- _PVRL2_ => _NECTIN2_ replacement, not found
- _KIAA1462_ => _JCAD_ replacement, not found
...
# for debug
target_genes_qc_replace <- c("LINC01600", "JCAD", "DUSP29", "NECTIN2")
...
expression_long2 <- expression_wide2 %>%
  ...
  mutate(gene = str_replace_all(gene, c("expression_value_sample" = "Mean of 1,000 genes"))) %>%
  mutate(gene = factor(gene, levels = c("Mean of 1,000 genes", target_genes_qc)))
