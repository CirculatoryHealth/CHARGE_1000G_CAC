...
PROJECT_loc = paste0(STORAGE_loc, "/analyses/consortia/CHARGE_1000G_CAC")
RESULTS = paste0(STORAGE_loc, "/analyses/consortia/CHARGE_1000G_CAC/AESCRNA")
...
CAC_gene_list <- read.xlsx(paste0(TARGET_loc, "/Genes.xlsx"))

CAC_variants <- read.xlsx(paste0(TARGET_loc, "/Variants.xlsx"))
...
------
<sup>&copy; 1979-2023 Sander W. van der Laan | s.w.vanderlaan-2[at]umcutrecht.nl | [swvanderlaan.github.io](https://vanderlaan.science).</sup>
------
