...
for(VARIANT in variants_of_interest){
  ...
  VARIANTNO <- subset(variant_list, rsID == VARIANT)[,1]
  ...
  ggsave(filename = paste0(RACER_loc, "/", VARIANTNO, ".", Today, ".",VARIANT,".regional_assoc.png"), plot = last_plot())
  ggsave(filename = paste0(RACER_loc, "/", VARIANTNO, ".", Today, ".",VARIANT,".regional_assoc.pdf"), plot = last_plot())
...
[add in the IGBP3 and ARID5B loci]
