...
2. Taking into account the issues of power, it is more likely that the majority of loci are shared between ancestries. The _ADK_ and _COL4A1_/_COL4A2_ loci are the least shared between ancestries, and both analyses are well-_under_powered for the _IGFBP3_ locus. 
