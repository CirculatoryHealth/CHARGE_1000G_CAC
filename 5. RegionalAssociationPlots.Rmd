...
gwas_sumstats_racer_EA_AA <- readRDS(file = paste0(OUT_loc, "/gwas_sumstats_racer.EA_AA.rds"))
gwas_sumstats_racer_EA_AA <- gwas_sumstats_racer
...
```{r}
gwas_sumstats_AA <- fread(paste0(GWAS_loc,"/CAC1000G_AA_FINAL_FUMA.unfiltered.txt.gz"),
                         showProgress = TRUE)

gwas_sumstats_racer_AA <- subset(gwas_sumstats,
                              select = c("MarkerName", "rsID", "Chr", "Position", "Pvalue"))
