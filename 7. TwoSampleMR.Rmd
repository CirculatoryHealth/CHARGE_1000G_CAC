---
title: "Causal effects of ardiometabolic risk factors on CAC"
...
Here we want to test whether cardiometabolic risk factors are causal to coronary artery calcification using Two Sample Mendelian Randomization (MR) as described [elsewhere](https://mrcieu.github.io/TwoSampleMR/index.html). To this end we will:

- load the results from the cardiometabolic risk factors 
- load the data from CAC GWAS using the proxies (r<sup>2</sup> = 1.0) of the top variants in the cardiometabolic risk factors GWAS'
...
------
    ...
    * v1.0.3 Update to the color scheme for TwoSample MR on model 2 and 3.
