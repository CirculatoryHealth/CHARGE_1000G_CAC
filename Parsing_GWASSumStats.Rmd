...
temp <- subset(gwas_sumstats,
               
               )
cat("\nFormatting association data.\n")
head(RACER::formatRACER(assoc_data = temp, chr_col = 3, pos_col = 4, p_col = 13))

cat("\nGetting LD data.\n")
head(RACER::ldRACER(assoc_data = temp, rs_col = 2, pops = "EUR", lead_snp = "rs3844006"))
...
RACER::singlePlotRACER(assoc_data = gwas_sumstats, chr = 14, build = "hg19", plotby = "gene", gene_plot = "MARK3")
